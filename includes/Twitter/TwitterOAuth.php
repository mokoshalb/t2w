...
class TwitterOAuth extends Config {
	...
	public function __construct(
		$consumerKey, $consumerSecret, $oauthToken = null,
	...
	private function oAuthRequest( $url, $method, array $parameters ) {
		$request = Request::fromConsumerAndToken( $this->consumer, $this->token,
		...
		if ( $this->bearer === null ) {
			$request->signRequest( $this->signatureMethod, $this->consumer,
				$this->token );
		...
		return $this->request( $request->getNormalizedHttpUrl(), $method,
